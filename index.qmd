...
deletion_vis_base <- "topic_models/deletion"
...
# after topic_k_range is set above
ojs_define(topic_k_min_ojs   = min(topic_k_range))
ojs_define(topic_k_max_ojs   = max(topic_k_range))
ojs_define(topic_k_step_ojs  = diff(topic_k_range)[1])
...
addition_vis_base <- "topic_models/addition"
...
ojs_define(topic_k_min_addition_ojs  = min(topic_k_range_addition))
ojs_define(topic_k_max_addition_ojs  = max(topic_k_range_addition))
ojs_define(topic_k_step_addition_ojs = diff(topic_k_range_addition)[1])
